...
- `hero-lattice.webp`: an original 3D geometric commit lattice used behind the landing preview. `hero-lattice-768.webp` is its locally resized mobile derivative.
