...
function footer(): string {
  return `<footer class="site-footer">
    ...
    <p class="build-id">v0.1.12 · Generated artwork disclosed</p>
  </footer>`;
}
...
function dashboard(mode: "demo" | "native"): string {
  ...
  return `${banner}<div class="app-shell">
    ...
    <main id="main" class="pulse-main">
      ...
      ${mode === "demo" ? `<footer class="app-footer"><span>Demo sample data stays separate from real data.</span><nav aria-label="Demo footer"><a href="/privacy" data-route>Privacy</a><a href="/terms" data-route>Terms</a><span>Built by Param Factory · v0.1.12</span></nav></footer>` : ""}
