...
try {
  ...
  assert((await liveDownload.getAttribute("href"))?.includes("/releases/download/v0.1.14/Worktree.Agent.Pulse_0.1.14_amd64.AppImage"), "live Linux download does not target v0.1.14");
  pass("live release download", "Linux button resolves through the GitHub API to the v0.1.14 AppImage");
